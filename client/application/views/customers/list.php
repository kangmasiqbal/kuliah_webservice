  <div clas="row">
    <div class="col-md-12">
      <div class="card">
        <h5 class="card-header">Data Customers <a href="<?php echo base_url('customers/create'); ?>" class="btn btn-sm btn-success float-right">Tambah Data</a></h5>
        <div class="card-body">
            ...
            <table id="myTable" class="table table-sm table-hover">
              ...
              <tbody>
                ...
                foreach ($customers as $m){
                  ...
                  <a href='".base_url('customers/edit/').$m->id."' class='btn btn-sm btn-warning'>Edit</a> 
